        ...
        function fnApplyEditable(aoNodes) {
            ...
            var oDefaultEditableSettings = {
                ...
                "onsubmit": function (settings, original) {
                    ...
                    if(settings.type === "text" || settings.type === "select" || settings.type === "textarea" || settings.type === "email" || settings.type === "number" )
                    {
                        var input = $("input,select,textarea,email,number", this);
                        sNewCellValue = $("input,select,textarea,email,number", $(this)).val();
                        if (input.length === 1) {
