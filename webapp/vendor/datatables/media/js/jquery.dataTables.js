...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<div class="input-group"><input type="search" class="'+classes.sFilterInput+' searchBox"/><span class="input-group-addon searchIcon"><i class="fa fa-search"></i></span></div>';
