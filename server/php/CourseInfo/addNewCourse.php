<?php
  ...
  include("../connect.php");
	...
	$regular_defense_applicable = $_POST["regular_defense_applicable"];
	...
	$redefense_applicable = $_POST["redefense_applicable"];
	...
	$outstanding_defense_applicable = $_POST["outstanding_defense_applicable"];
    ...
    mysql_query("INSERT INTO course (code, name, description, unit, phase_code, department_code, start_regular_defense_week,
				 ...
				 '$end_outstanding_defense_week','$outstanding_defense_minute','$outstanding_defense_applicable','$deadline_of_deliverable')");
