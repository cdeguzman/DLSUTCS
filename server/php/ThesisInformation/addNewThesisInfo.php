...
// This code will add new thesis group
  include("../connect.php");
   ...
   $status1 = mysql_query("INSERT INTO thesis (id, primary_name, secondary_name, proposal_abstract, final_abstract, description, start_sy, end_sy,
                                    start_term, end_term)
                VALUES ('$id','$primary_name','$secondary_name','$proposal_abstract','$final_abstract','$description',
                        '$start_sy','$end_sy','$start_term','$end_term')");
						
   $status2 = mysql_query("INSERT INTO thesis_adviser (thesis_id, faculty_id, start_sy, term) VALUES ('$id', '$faculty_id', '$start_sy', '$start_term')");
